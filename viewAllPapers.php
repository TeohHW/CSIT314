    ...
    <body>
        ...
        if (isset($_SESSION["user"])) {
            ...
            if ($user->get_type() == "ConferenceChair") 
			{
                ...
                $paperArr = [];
                $paperObj = new Papers();
                $paperArr = $paperObj->listAllPapers($user_name);
            }
            else 
			{
		...
		<div class="wrapper">
            ...
            if ($paperArr != NULL) 
			{
                ...
                foreach ($paperArr as $paper) 
				{
					...
					if ($paper->get_paperStatus() == "Reviewing") 
					{
						echo "<td><a href='acceptRejectPaper.php?paperNo={$paper->get_paperNo()}'>Accept/Reject</a></td>";
                    }
					else
					{
						echo "<td><a href='viewPaperInfo.php?paperNo={$paper->get_paperNo()}'>View</a></td>";
					}
